...
namespace GHA_StadiumTools
{
    ...
    public class ST_ConstructBowlPlan : GH_Component
    {
        ...
        {
            var newBowlPlan = new StadiumTools.BowlPlan();
            ...
            newBowlPlan.PlaySurfaceParameters = playSurfaceGooItem.Value;
            DA.GetData<StadiumTools.BoundaryGoo>(IN_Boundary, ref boundaryGooItem);
            newBowlPlan.Boundary = boundaryGooItem.Value;
            newBowlPlan.IsValid = true;
