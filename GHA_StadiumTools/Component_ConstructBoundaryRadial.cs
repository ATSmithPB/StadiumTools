...
namespace GHA_StadiumTools
{
    ...
    /// </summary>
    public class ST_ConstructBoundaryRadial : GH_Component
    {
        /// <summary>
        /// A custom component for input parameters to generate a new 2D section. 
        /// </summary>
        public ST_ConstructBoundaryRadial()
            : base(nameof(ST_ConstructBoundaryRadial), "cbR", "Construct a Radial Boundary (Front Bowl Edge) from Parameters", "StadiumTools", "2D Plan")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            StadiumTools.Boundary newBoundary = ST_ConstructBoundaryRadial.ConstructBoundaryRadialFromDA(DA, this);
            ...
            //Creat new GH_Goo<T> wrapper and output
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Resources.ST_ConstructBoundaryRadial;
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("378a97f9-63f0-45a0-9357-df58a3c34c5e");

        //Methods  
        private static StadiumTools.Boundary ConstructBoundaryRadialFromDA(IGH_DataAccess DA, GH_Component thisComponent)
        {
