...
namespace GHA_StadiumTools
{
    ...
    /// </summary>
    public class ST_ConstructBoundaryElliptical : GH_Component
    {
        /// <summary>
        /// A custom component for input parameters to generate a new 2D section. 
        /// </summary>
        public ST_ConstructBoundaryElliptical()
            : base(nameof(ST_ConstructBoundaryElliptical), "cbE", "Construct an Elliptical or Circular Boundary (Front Bowl Edge) from Parameters", "StadiumTools", "2D Plan")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Offset", "bw", "The width of bays (per side)", GH_ParamAccess.list, new List<double>() { bw, bw, bw, bw });
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            StadiumTools.Boundary newBoundary = ST_ConstructBoundaryElliptical.ConstructBoundaryEllipticalFromDA(DA, this);
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Resources.ST_ConstructBoundaryElliptical;
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("49b021df-e99e-4b35-850e-4c3a79744e06");

        //Methods  
        private static StadiumTools.Boundary ConstructBoundaryEllipticalFromDA(IGH_DataAccess DA, GH_Component thisComponent)
        {
