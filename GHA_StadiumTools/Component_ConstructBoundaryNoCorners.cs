...
namespace GHA_StadiumTools
{
    ...
    /// </summary>
    public class ST_ConstructBoundaryNoCorners : GH_Component
    {
        /// <summary>
        /// A custom component for input parameters to generate a new 2D section. 
        /// </summary>
        public ST_ConstructBoundaryNoCorners()
            : base(nameof(ST_ConstructBoundaryNoCorners), "cbNC", "Construct an orthagonal Boundary (Front Bowl Edge) with open corners from Parameters", "StadiumTools", "2D Plan")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            StadiumTools.Boundary newBoundary = ST_ConstructBoundaryNoCorners.ConstructBoundaryNoCornersFromDA(DA, this);
        ...
        /// </summary>
        protected override System.Drawing.Bitmap Icon => Resources.ST_ConstructBoundaryNoCorners;
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("eaceb525-37c0-4ba7-b588-5270f48a8412");

        //Methods  
        private static StadiumTools.Boundary ConstructBoundaryNoCornersFromDA(IGH_DataAccess DA, GH_Component thisComponent)
        {
